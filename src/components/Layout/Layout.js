        ...
        <Fragment>
            <Flex position='fixed' top={0} w={['100%']} align='center' justify={'space-between'} px={'15px'} py={'20px'} bgColor='#000000'>
                ...
                <Drawer isOpen={isOpen} placement='right' onClose={onClose} finalFocusRef={btnRef}>
                    <DrawerOverlay />
                    <DrawerContent borderRadius={'15px 0 0 15px'}>
                        <DrawerCloseButton />
                        <DrawerBody display={'flex'} flexDirection={'column'} gap={'25px'} pt={'70px'}>
                            <Flex gap={'5px'}><Icon as={GiHamburger} w={'35px'} h={'35px'} /><Text fontFamily={'sans-serif'} fontWeight={700} fontSize={'25px'}>HOME</Text></Flex>
                            <Flex gap={'5px'}><Icon as={BiFoodMenu} w={'35px'} h={'35px'} /><Text fontFamily={'sans-serif'} fontWeight={700} fontSize={'25px'}>MENU</Text></Flex>
                            <Flex gap={'5px'}><Icon as={HiUserGroup} w={'35px'} h={'35px'} /><Text fontFamily={'sans-serif'} fontWeight={700} fontSize={'25px'}>SOBRE NÓS</Text></Flex>
